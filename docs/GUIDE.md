...
| Admin-brugernavn | `adm-mpark` | Domain Join |
...
| Filserver (Q-Drive) | `ait-pdfs` / `ait-pqumulo.win.dtu.dk` | 445 |
| Printserver | `print.sustain.dtu.dk` | 445 |
| Defender onboarding | `defender.ait.dtu.dk` | 443 |
...
| Problem | Løsning |
|---------|---------|
| Mount fejler | Tjek credentials og netværk: `smbclient -L //ait-pdfs -U mpark` |
