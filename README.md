...
| **Q-Drive** | CIFS-mount af `\\ait-pdfs\Qdrev\SUS` | ✅ |
...
(Kan løses ved at installer kde-standard før installation af dette program)
...
```bash
# Kør disse hvis du hellere vil gøre det manuelt uden KDE.
...
* - kræver bruger selv taster username og kode.
...
|------|-------------|-------------------|
| Q-Drive | `//ait-pdfs/Qdrev/SUS` | `/mnt/Qdrev` |
| P-Drive (Ubuntu) | `//ait-pdfs/Qdrev/SUS/Personal/<user>` | `/mnt/Personal` |

> **openSUSE note:** Bruger direkte sti `//ait-pqumulo.win.dtu.dk/sus-q$` for at omgå en kernel DFS-bug.
...
4. Kører onboarding fra `https://defender.ait.dtu.dk`
...
| Printer | Type | Server |
|---------|------|--------|
| FollowMe-MFP-PCL | Multifunktion | `print.sustain.dtu.dk` |
| FollowMe-Plot-PS | Plotter | `print.sustain.dtu.dk` |
...
Software-modulet bruger en konfigurerbar liste i stedet for hardkodede pakker.
